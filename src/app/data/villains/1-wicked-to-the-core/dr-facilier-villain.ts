...
export const DR_FACILIER: Villain = {
  ...
  mechanics: `Dr. Facilier has a special mechanic called the Fortune pile. 
  Some cards he plays automatically go to the Fortune pile, while cards in his Fate deck can add other cards to it. 
  When he plays The Cards Will Tell, he reveals three cards at random from the Fortune pile. 
